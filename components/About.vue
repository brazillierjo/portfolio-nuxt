...
<template>
  <section id="About" class="flex flex-col items-center xl:items-start gap-6 xl:-mt-6 xl:min-h-screen xl:justify-center xl:gap-12">
    <Tag>
    ...
    <div class="text-md flex flex-col gap-6">
      <p class="text-justify xl:text-text">
      ...
      <p class="text-justify xl:text-text">
        🍀 As a SEO specialist, working closely with developers sparked my interest in this highly technical field.
        Therefore, I enrolled in a 6-month bootcamp training program to acquire the fundamentals of web programming and
        coding. Following that, I continued my learning journey through an apprenticeship program, pursuing a degree in
        Web and Mobile Applications Integration/Development with a specialization in React and Node.js.
      </p>
      ...
      <p class="text-justify xl:text-text">
        👷 Today, drawing strength from my journey, I master the intricacies of the Agile methodology, the principles of
        Clean Code, and CI/CD pipelines, ensuring optimal scalability and maintainability for each web application I
        develop. My diverse experience, spanning from SEO to programming, enables me to bring a unique perspective to
        every project.
      </p>

      <p class="text-justify xl:text-text">
        🧘‍♂ As a Web Developer since 2020, I thoroughly enjoy working with Nuxt & NextJs in an Agile environment,
        adhering to clean code principles, and implementing CI/CD pipelines. I take pleasure in transforming mockups of
